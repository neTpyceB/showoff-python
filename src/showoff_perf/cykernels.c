...
{
    "distutils": {
        "name": "showoff_perf.cykernels",
        "sources": [
            "src/showoff_perf/cykernels.pyx"
        ]
    },
    "module_name": "showoff_perf.cykernels"
}
END: Cython Metadata */
...
#define __PYX_HAVE__showoff_perf__cykernels
#define __PYX_HAVE_API__showoff_perf__cykernels
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "showoff_perf.cykernels" */
static int __pyx_f_12showoff_perf_9cykernels__is_prime(PY_LONG_LONG); /*proto*/
static PY_LONG_LONG __pyx_f_12showoff_perf_9cykernels_sum_primes_in_range(PY_LONG_LONG, PY_LONG_LONG, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "showoff_perf.cykernels"
extern int __pyx_module_is_main_showoff_perf__cykernels;
int __pyx_module_is_main_showoff_perf__cykernels = 0;

/* Implementation of "showoff_perf.cykernels" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12showoff_perf_9cykernels_sum_primes_in_range(CYTHON_UNUSED PyObject *__pyx_self, PY_LONG_LONG __pyx_v_start, PY_LONG_LONG __pyx_v_stop); /* proto */
...
#define __pyx_kp_u_src_showoff_perf_cykernels_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_showoff_perf_cykernels __pyx_string_tab[15]
#define __pyx_n_u_start __pyx_string_tab[16]
#define __pyx_n_u_stop __pyx_string_tab[17]
#define __pyx_n_u_sum_primes_in_range __pyx_string_tab[18]
#define __pyx_n_u_test __pyx_string_tab[19]
#define __pyx_n_u_values __pyx_string_tab[20]
#define __pyx_kp_b_iso88591_1_1_q_q_9AQ_Q_1 __pyx_string_tab[21]
...
static int __pyx_f_12showoff_perf_9cykernels__is_prime(PY_LONG_LONG __pyx_v_number) {
 ...
 *     divisor = 3
*/
  __pyx_t_1 = (__Pyx_mod_PY_LONG_LONG(__pyx_v_number, 2, 1) == 0);
  if (__pyx_t_1) {

    /* "showoff_perf/cykernels.pyx":10
 *         return True
 *     if number % 2 == 0:
 *         return False             # <<<<<<<<<<<<<<
 *     divisor = 3
...
*/
  while (1) {
    __pyx_t_1 = ((__pyx_v_divisor * __pyx_v_divisor) <= __pyx_v_number);
    if (!__pyx_t_1) break;

    /* "showoff_perf/cykernels.pyx":13
 *     divisor = 3
 *     while divisor * divisor <= number:
 *         if number % divisor == 0:             # <<<<<<<<<<<<<<
 *             return False
...
*/
    ...
    __pyx_t_1 = (__Pyx_mod_PY_LONG_LONG(__pyx_v_number, __pyx_v_divisor, 0) == 0);
    if (__pyx_t_1) {

      /* "showoff_perf/cykernels.pyx":14
 *     while divisor * divisor <= number:
 *         if number % divisor == 0:
 *             return False             # <<<<<<<<<<<<<<
 *         divisor += 2
 ...
 * 
*/
    __pyx_v_divisor = (__pyx_v_divisor + 2);
  }

  /* "showoff_perf/cykernels.pyx":16
 *             return False
 *         divisor += 2
 *     return True             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("showoff_perf.cykernels._is_prime", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}

/* "showoff_perf/cykernels.pyx":19
 * 
 * 
...
static PyObject *__pyx_pw_12showoff_perf_9cykernels_1sum_primes_in_range(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PY_LONG_LONG __pyx_f_12showoff_perf_9cykernels_sum_primes_in_range(PY_LONG_LONG __pyx_v_start, PY_LONG_LONG __pyx_v_stop, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PY_LONG_LONG __pyx_v_total;
  PY_LONG_LONG __pyx_v_number;
 ...
 *     return total
*/
    __pyx_t_4 = __pyx_f_12showoff_perf_9cykernels__is_prime(__pyx_v_number); if (unlikely(__pyx_t_4 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L1_error)
    if (__pyx_t_4) {

      /* "showoff_perf/cykernels.pyx":24
 *     for number in range(start, stop):
 *         if _is_prime(number):
 *             total += number             # <<<<<<<<<<<<<<
 *     return total
*/
      __pyx_v_total = (__pyx_v_total + __pyx_v_number);
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("showoff_perf.cykernels.sum_primes_in_range", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1LL;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyMethodDef __pyx_mdef_12showoff_perf_9cykernels_1sum_primes_in_range = {"sum_primes_in_range", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12showoff_perf_9cykernels_1sum_primes_in_range, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12showoff_perf_9cykernels_1sum_primes_in_range(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("sum_primes_in_range (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "sum_primes_in_range", 0) < (0)) __PYX_ERR(0, 19, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("sum_primes_in_range", 1, 2, 2, i); __PYX_ERR(0, 19, __pyx_L3_error) }
      }
    ...
    __pyx_v_start = __Pyx_PyLong_As_PY_LONG_LONG(values[0]); if (unlikely((__pyx_v_start == (PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_stop = __Pyx_PyLong_As_PY_LONG_LONG(values[1]); if (unlikely((__pyx_v_stop == (PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("sum_primes_in_range", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_12showoff_perf_9cykernels_sum_primes_in_range(__pyx_self, __pyx_v_start, __pyx_v_stop);
...
static PyObject *__pyx_pf_12showoff_perf_9cykernels_sum_primes_in_range(CYTHON_UNUSED PyObject *__pyx_self, PY_LONG_LONG __pyx_v_start, PY_LONG_LONG __pyx_v_stop) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("sum_primes_in_range", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_12showoff_perf_9cykernels_sum_primes_in_range(__pyx_v_start, __pyx_v_stop, 1); if (unlikely(__pyx_t_1 == ((PY_LONG_LONG)-1LL) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
...
static int __pyx_pymod_exec_cykernels(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cykernels},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_cykernels(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cykernels(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cykernels(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cykernels' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cykernels" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cykernels", 0);
  ...
  if (__pyx_module_is_main_showoff_perf__cykernels) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "showoff_perf.cykernels")) {
      if (unlikely((PyDict_SetItemString(modules, "showoff_perf.cykernels", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef long long number
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12showoff_perf_9cykernels_1sum_primes_in_range, 0, __pyx_mstate_global->__pyx_n_u_sum_primes_in_range, NULL, __pyx_mstate_global->__pyx_n_u_showoff_perf_cykernels, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_sum_primes_in_range, __pyx_t_2) < (0)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "showoff_perf/cykernels.pyx":1
 * # cython: language_level=3             # <<<<<<<<<<<<<<
 * 
 * cdef bint _is_prime(long long number):
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init showoff_perf.cykernels", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init showoff_perf.cykernels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{30},{20},{18},{18},{8},{13},{5},{8},{10},{8},{3},{12},{12},{10},{22},{5},{4},{19},{8},{6},{42}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (219 bytes) */
const char* const cstring = "(\265/\375`\032\000\215\006\000\302\016/'\200k:\233\014Fb C\311\2048\026\305-e[\333\335\361C\177\362\373\326\032\204\200\003bR}\030d\364bX\246l\321Ex\262\010f(d\021\254\201-.\202 \2434\001\r\205%\260\301%x:\221\346\360d\321\006\001\340\360\326\3300\177\363\366\277\025\331\350%<\257\004\351t\251\3624\233\233\266f\250cmo)\275\334\313\177l\225\372\2479\375+5\371\377\033+eJ\377/a\223~\226\266\341\031\376w\262\276\377\342\332d]\243}\t\277\022F\307+a\327I\247\203&t\322\342\366V\322\325>\336\016:*\013\362W\326\004q\\I\367b9\305\243;\375\275\231\231\026V8\312\214\006\000P\010\227\341\310g\326\2209\n/Ul\002.\031";
    PyObject *data = __Pyx_DecompressString(cstring, 219, 3);
...
const char* const cstring = "x\332M\216=N\303@\020\205),\021\021Z*JD\353\310%U\204\224:\n\\\340i\331\214a\225\375\363\316,\3047p\351\322%G\242t\311Q\330\010\0241\3057o4o4o\315I\257\370-|\204\266E\244\324\256t\177\240\344\311r\035\373#\260+\330\365\033\243\005[:\3123\265\212{\257M\250uH!\213\361\304\332\026\302xHR\232^\224>\000m\366\032\200a\234}F\3101\340Tq\226ra\237-\235\224W\256\364\030\"\320ee\177G\200I\376VE\355\313\343l\345\177\324\372\034\225E%a\t\221\263CL\306\021\237\342$\345_\313\265\020\013\360\256l&\376\272\270\373l\346\352vj\276\253\305p5\336\217\335t9u\363b9<\214\217\343\323|}SP-\207\346\007\276,p\272";
...
const char* const bytes = "?src/showoff_perf/cykernels.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func___is_coroutineitems__main____module____name__pop__qualname____set_name__setdefaultshowoff_perf.cykernelsstartstopsum_primes_in_range__test__values\320\000#\2401\330\004\033\2301\340\004\010\210\n\220%\220q\230\007\230q\330\010\013\2109\220A\220Q\330\014\025\220Q\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_start, __pyx_mstate->__pyx_n_u_stop};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_showoff_perf_cykernels_pyx, __pyx_mstate->__pyx_n_u_sum_primes_in_range, __pyx_mstate->__pyx_kp_b_iso88591_1_1_q_q_9AQ_Q_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
